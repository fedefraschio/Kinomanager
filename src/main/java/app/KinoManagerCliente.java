...
public class KinoManagerCliente extends Application {
	...
	private void initData()
	{
		...
		Spettacolo s1=new Spettacolo(GiornoDellaSettimana.Venerdì,
				new Film("Fast X","Azione"), new Sala(5,200),
				LocalTime.of(21, 0));
		Spettacolo s2=new Spettacolo(GiornoDellaSettimana.Lunedì,
				new Film("Love Again","Romantico"), new Sala(4,50),
				LocalTime.of(15,30));
		Spettacolo s3=new Spettacolo(GiornoDellaSettimana.Sabato,
		...
		Recensione r1=new Recensione("Super topperia missile",5,new Film("Love again"));
		Recensione r2=new Recensione("Anvedi che monnezza",1,new Film("Fast X"));
		data.addRecensione(r1);
		data.addRecensione(r2);
	}
