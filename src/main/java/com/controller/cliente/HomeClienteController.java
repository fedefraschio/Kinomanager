...
public class HomeClienteController {
	...
	{
		FXMLLoader loader=new FXMLLoader(getClass().getResource("/com/controller/cliente/ViewAcquista.fxml"));
		root=loader.load();
	...
	{
		FXMLLoader loader=new FXMLLoader(getClass().getResource("/com/controller/cliente/ViewMostraProgrammazione.fxml"));
		root=loader.load();
	...
	{
		FXMLLoader loader=new FXMLLoader(getClass().getResource("/com/controller/cliente/ViewRecensioni.fxml"));
		root=loader.load();
