...
public class HomeGestoreController {
	...
	{
		FXMLLoader loader=new FXMLLoader(getClass().getResource("/com/controller/gestore/ViewPubblicaSconti.fxml"));
		root=loader.load();
	...
	{
		FXMLLoader loader=new FXMLLoader(getClass().getResource("/com/controller/gestore/ViewGestioneProgrammazione.fxml"));
		root=loader.load();
	...
	{
		FXMLLoader loader=new FXMLLoader(getClass().getResource("/com/controller/gestore/ViewImpostaPrezzi.fxml"));
		root=loader.load();
	...
	{
		FXMLLoader loader=new FXMLLoader(getClass().getResource("/com/controller/gestore/ViewAggiungiCassiere.fxml"));
		root=loader.load();
	...
	{
		FXMLLoader loader=new FXMLLoader(getClass().getResource("/com/controller/gestore/ViewRimuoviCassiere.fxml"));
		root=loader.load();
